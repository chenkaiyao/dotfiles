...
;; Copyright (C) " (substring (current-time-string) -4) " by chenkaiyao " "
;; Author: chenkaiyao"
'(end-of-line 1) " <" (user-login-name) ?@ "chenkaiyao@gmail.com>
(defconst "
...
(setq auto-insert-alist
      (append '(
                (("\\.go$" . "golang header")
                 ...
                 "// @Author: chenkaiyao <chenkaiyao@gmail.com>\n"
...
(setq auto-insert-alist
      (append '(
                (("\\.erl$" . "erlang header")
                 ...
                 "%%% @Author: chenkaiyao <chenkaiyao@rosinno.com>\n"
                 "%%% @Date   Created: " (format-time-string "%Y-%m-%d %H:%M:%S")"\n"
                 "%%%-------------------------------------------------------------------\n"
                 _
                 ))
